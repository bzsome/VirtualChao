...
public class SettingsActivity extends VActivity {
    ...
    private static final String LOCATION_KEY = "settings_location";
    ...
    public static class SettingsFragment extends PreferenceFragment {
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            Preference location = findPreference(LOCATION_KEY);
            ...
            location.setOnPreferenceClickListener((Preference preference) -> {
                startActivity(new Intent(getActivity(), VirtualLocationSettings.class));
                return false;
            });
